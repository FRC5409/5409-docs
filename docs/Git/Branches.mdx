...
:::info
Once the pull request has been approved, you typically have 3 options to pick between when merging the branch. Those being **merge commit**, **squash and merge**, and **rebase and merge**. In most cases, when working on the robot repository you should be using **squash and merge**.
:::


:::tip
Before creating a pull request, pull the latest changes from the target branch. This mitigates the risk of having merge conflicts. Remember to also test your code once again after doing so as changes brought in from any other branch could cause unexpected errors.
:::
...
As shown in the flow chart above, a 4 stage workflow when implemengint new features or fixing issues. Once a branch is created and the required changes are made, the developer can innitiate a pull request. The pull request must then be reviewed and approved by another member of the programming team before it is pushed into main. As a general rule of thumb, all new features or changes to code must be tested on the robot before being pulled into main.
...
When creating a pull request, you will be given the option to pick the **<span style={{ color: "#e67a73" }}>target branch</span>** that you would like your **<span style={{ color: "#62bea9" }}>current branch</span>** to be merged into. Once you have ensured that the appropriate branches are selected, you can go ahead and create the pull request.
